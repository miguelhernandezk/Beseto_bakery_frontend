    ...
    <>
      <Layout>
        ...
        >
          ...
          <section
            id="discover"
            className="text-white  xl:bg-white w-full flex"
          >
            ...
            <div className="text-container bg-beseto-dark-gray p-8 md:p-20 xl:w-1/2 flex flex-col justify-center">
              ...
              <p className="text-sm leading-loose">
                ...
                panqué y pan de dulce. Además tambien hacemos pedidos para
                eventos de bodas, comuniones, bautizos, XV años y màs. Acércate
                y pregunta para pedidos personalizados.
              </p>
            </div>
          </section>
          <Container className="flex flex-col items-center justify-center">
