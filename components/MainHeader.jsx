...
const MainHeader = () => {
  return (
    <header className="parallax-container relative h-full">
        <img
        ...
        />
        <div className="darkened w-full h-full absolute z-0"></div>
        <div className="info-container w-full h-full flex flex-col items-center absolute text-neutral-100 place-content-around p-8 pt-5 z-30">
          <div className="info-text-container h-full sm:w-96 md:w-128 flex flex-col items-center place-content-around relative">
            ...
            <p className="text-center mb-10 w-full sm:text-lg md:text-2xl">Aunque no lo creas, no solo es un pastel. Es él pastel. Y sabemos que te encantará</p>
            <a href="#cotizador"><button className="outline outline-2 outline-neutral-100 rounded mb-12 p-3 hover:bg-beseto-bisque hover:text-beseto-chocolate hover:outline-beseto-chocolate sm:text-lg md:mb-0" type="button">Cotiza ahora</button></a>
