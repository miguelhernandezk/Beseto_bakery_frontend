...
const ProductExamples = () => {
  return (
    <section
      id="product-examples"
      className="ProductExamples p-10 sm:px-2 md:w-160 flex flex-col gap-y-10 w-80 sm:w-96 items-center xl:w-300 max-w-screen-xl xl:flex-row xl:flex-wrap xl:px-0 xl:gap-x-3 xl:pb-32"
    >
      <Card
        dark
